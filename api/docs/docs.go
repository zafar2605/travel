    ...
    "paths": {
        "/airport": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "DeleteAirportRequestBody",
                        "name": "object",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/city": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "DeleteCityRequestBody",
                        "name": "object",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/city/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "GetByIdCityResponseBody",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/handler.Response"
        ...
        "/country/{id}": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "DeleteCountryRequestBody",
                        "name": "object",
                        "in": "body",
                        "required": true,
                        "schema": {
